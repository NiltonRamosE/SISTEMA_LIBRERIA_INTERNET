...
import presentacion.ITarjeta;
import presentacion.PresentadorProducto;
import presentacion.PresentadorTarjeta;

public class ModuloTarjeta extends javax.swing.JPanel implements ITarjeta{

    public ModuloTarjeta() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("MODULO TARJETA");
        ...
        registrosTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {},
            new String [] {"ID", "Cliente", "Numero Cuenta", "Fecha Limite", "Saldo"}
        ));
    ...
    public void setPresentador(PresentadorTarjeta ptarjeta) {
        deleteButton.addActionListener(ptarjeta);
        insertButton.addActionListener(ptarjeta);
    }
