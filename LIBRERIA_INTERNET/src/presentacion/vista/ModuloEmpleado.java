...
import presentacion.IEmpleado;
import presentacion.PresentadorEmpleado;

public class ModuloEmpleado extends javax.swing.JPanel implements IEmpleado{
    ...
    private void initComponents() {
        ...
        jLabel1.setText("MODULO EMPLEADO");
    ...
    public void setPresentador(PresentadorEmpleado pempleado) {
        deleteButton.addActionListener(pempleado);
        insertButton.addActionListener(pempleado);
        searchButton.addActionListener(pempleado);
        updateButton.addActionListener(pempleado);
    }
